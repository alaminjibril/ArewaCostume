...
export async function POST(request) {
    try {
        ...
        // link store to the user or connect this store with the user
...
//check if user have alredy registered the store if yes then send status of the store
