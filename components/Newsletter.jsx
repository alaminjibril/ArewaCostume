...
const Newsletter = () => {
    return (
        <div className='flex flex-col items-center mx-4 my-36'>
            <Title title="Join the ArewaCostume Community" description="Stay connected with Arewa culture! Subscribe to receive exclusive updates on new traditional designs, fashion tips, and upcoming collections from ArewaCostume." visibleButton={false} />
