...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Why Choose ArewaCostume' description="At ArewaCostume, we celebrate the beauty of Northern Nigerian heritage through quality craftsmanship, cultural authenticity, and timeless fashion. Every outfit tells a story of tradition and pride." />
